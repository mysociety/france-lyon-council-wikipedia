...
class LyonCouncilPage < Scraped::HTML
  field :councillors do
    noko.xpath('.//table[2]/tr[td]').map do |tr|
...
wikipedia_url = 'https://fr.wikipedia.org/wiki/Liste_des_conseillers_de_la_m%C3%A9tropole_de_Lyon'

page = scrape(wikipedia_url => LyonCouncilPage)
